...
// Only breeders can declare dead animals
// Breeders can only declare dead the animals they own
// The dead animal should be subtracted from the breeders NFTs
// The dead animal shouldn't have any characteristics
...
// func assert_only_owner_breeder{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(token_id: Uint256) {
//     let (sender_address) = get_caller_address();
//     let (owner: felt) = ERC721.owner_of(token_id);
    
//     let (is_true) = is_breeder.read(sender_address);
//     with_attr error_message("Caller is not the animal breeder") {
