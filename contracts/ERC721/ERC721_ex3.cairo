...
// Keep track of the breeders contracts:
// @storage_var is_breeder
// Create a view to check if the account is a breeder
// @view func is_account_breeder
// Allow accounts to become breeders (only the owner can do that)
// @external func add_breeder
// Remove breeders
// @external func remove_breeder (only the owner can do that)
// Only allow breeder and the contract owner to mint new animals
// Change the create_animal func
